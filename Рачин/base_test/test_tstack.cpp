...
TEST(TQueue, check_IsEmpty_with_empty_stack)
{
	TQueue<int> st(5);
	EXPECT_EQ(true, st.IsEmpty());
}
TEST(TQueue, check_IsEmpty_with_not_empty_stack)
{
	TQueue<int> st(5);
	st.Put(2);
	EXPECT_EQ(false, st.IsEmpty());
}
TEST(TQueue, check_IsFull_with_full_stack)
{
	TQueue<int> st(2);
	st.Put(1);
	st.Put(2);
...
TEST(TQueue, check_IsFull_with_not_full_stack)
{
	TQueue<int> st(5);
	st.Put(2);
